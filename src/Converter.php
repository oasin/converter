...
namespace Oasin\BitcoinCurrencyConverter;

use GuzzleHttp\Client;
use Oasin\BitcoinCurrencyConverter\Provider\CoinbaseProvider;
use Oasin\BitcoinCurrencyConverter\Provider\ProviderInterface;
...
class Converter
{
     ...
     * Provider instance.
     *
     * @var Oasin\BitcoinCurrencyConverter\Provider\ProviderInterface
     */
    protected $provider;
     ...
     * @param  float $rate
     * @return float
     * @throws Oasin\BitcoinCurrencyConverter\Exception\InvalidArgumentException
     */
